...
/**
 * OpenapiShouli generated by hbm2java
 */
@Entity
@Table(name = "OPENAPI_SHOULI", schema = "NEW_BPP")
public class OpenapiShouli implements java.io.Serializable {
	...
	public OpenapiShouli() {
	}

	public OpenapiShouli(String id, String yxtywlsh, long sort, char delFlag, String sjbbh, String blbm, String zrsj,
			String slzt) {
		this.id = id;
	...
	public OpenapiShouli(String id, String yxtywlsh, String slh, long sort, String createBy, Date createDate,
			String updateBy, Date updateDate, String remarks, char delFlag, String sjbbh, String blbm,
			String zrsj, String slzt, String byslyy, String bz, String byzda, String byzdb) {
		this.id = id;
		this.yxtywlsh = yxtywlsh;
		this.slh = slh;
		this.sort = sort;
	...
	@Column(name = "SLZT", nullable = false, length = 2)
	...
	@Column(name = "BYSLYY", length = 1200)
